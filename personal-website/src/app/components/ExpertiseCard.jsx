...
export default function ExpertiseCard() {
  return (
    <article
      className="border-solid border-2 border-[#525252] p-9 shadow-custom transition ease-in-out hover:shadow-custom-hover hover:-translate-y-1 hover:scale-105 overflow-hidden ">
