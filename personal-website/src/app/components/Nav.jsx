...
export default function Nav() {
  ...
  return (
    <>
      ...
      {screenWidth < 1500 ?
        <div className={`fixed h-screen w-screen bg-main-color-gray z-40 ${showNavbar ? '' : ''} ${navbarHidden ? 'hidden' : ''}`}>
          <nav className="inline-flex items-baseline flex-col font-header text-orange-200 pt-20 p-7 w-full">
            <a href="#home-section" className="text-3vh w-full mb-2" ><span>Home</span></a>
            <a href="#expertise-section" className="text-3vh w-full mb-2" ><span>Expertise</span></a>
            <a href="#work-section" className="text-3vh w-full mb-2" ><span>Work</span></a>
            <a href="#experience-section" className="text-3vh w-full mb-2" ><span>Experience</span></a>
            <a href="#contact-section" className="text-3vh w-full mb-2" ><span>Contact</span></a>
          </nav>
        </div>
        : null}
    </>
