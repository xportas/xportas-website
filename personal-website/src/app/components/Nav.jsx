        ...
        <div className="fixed left-1/2 transform -translate-x-1/2 z-10">
          <nav className={`flex font-header text-orange-200 bg-main-color-gray px-5 py-1 border-solid border-2 border-orange-200 shadow-custom ${showNavbar ? 'animate-fadeIn' : 'animate-fadeOut'} ${navbarHidden ? 'hidden' : ''}`}>
            ...
            <div className="relative z-30 flex items-center justify-center">
              <a href="#home-section" className="px-3 m-2 hover:-translate-y-2 hover:translate-x-2 hover:my-1 hover:pt-0 transition-all duration-150" onMouseOver={() => handleNavbarOnHover('home', true)} onMouseLeave={() => handleNavbarOnHover('home', false)}><span className={`bg-main-color-gray bg-clip-text`} >Home</span></a>
              <a href="#expertise-section" className="px-3 m-2 hover:-translate-y-2 hover:translate-x-2 hover:my-1 hover:pt-0 transition-all duration-150" onMouseOver={() => handleNavbarOnHover('expertise', true)} onMouseLeave={() => handleNavbarOnHover('expertise', false)}><span className={`bg-main-color-gray bg-clip-text`} >Expertise</span></a>
              <a href="#work-section" className="px-3 m-2 hover:-translate-y-2 hover:translate-x-2 hover:my-1 hover:pt-0 transition-all duration-150" onMouseOver={() => handleNavbarOnHover('work', true)} onMouseLeave={() => handleNavbarOnHover('work', false)}><span className={`bg-main-color-gray bg-clip-text`} >Work</span></a>
              <a href="#experience-section" className="px-3 m-2 hover:-translate-y-2 hover:translate-x-2 hover:my-1 hover:pt-0 transition-all duration-150" onMouseOver={() => handleNavbarOnHover('experience', true)} onMouseLeave={() => handleNavbarOnHover('experience', false)}><span className={`bg-main-color-gray bg-clip-text`} >Experience</span></a>
              <a href="#contact-section" className="px-3 m-2 hover:-translate-y-2 hover:translate-x-2 hover:my-1 hover:pt-0 transition-all duration-150" onMouseOver={() => handleNavbarOnHover('contact', true)} onMouseLeave={() => handleNavbarOnHover('contact', false)}><span className={`bg-main-color-gray bg-clip-text`} >Contact</span></a>
            </div>
          </nav>
        </div>
