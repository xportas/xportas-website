  ...
  return (
    ...
    >
      <h3
        ...
        className={`flex items-center justify-center mb-14 font-header text-short-heading ${dashedLine}`}
      >
        ...
        {projects &&
          Object.entries(projects).map(([key, project], i) => {
            ...
            return (
              ...
              >
                <div className="relative col-[1_/_7] row-span-full max-[1080px]:col-[1_/_9] max-[768px]:flex max-[768px]:flex-col max-[768px]:justify-center max-[768px]:h-full max-[768px]:col-span-full max-[768px]:z-[5] max-[768px]:pt-10 max-[768px]:pb-[30px] max-[768px]:px-10 max-[480px]:pt-[30px] max-[480px]:pb-5 max-[480px]:px-[25px]">
                  <div>
                    ...
                    <div className="relative z-20 p-6 rounded bg-main-gray text-orange-200 text-lg max-[768px]:text-main-gray max-[768px]:bg-transparent max-[768px]:shadow-none max-[768px]:px-0 max-[768px]:py-5 shadow-custom transition-all duration-[0.25s] ease-in">
                      <p>{description}</p>
                    </div>
                    ...
                    {tech.length && (
                      ...
                      >
                        {tech.map((skill, j) => (
                          <li
                            key={j}
                            className="text-secondary-gray max-[768px]:text-orange-800 text-[13px] whitespace-nowrap ml-0 mr-5 mt-0 mb-[5px] max-[768px]:text-[#ccd6f6)] max-[768px]:ml-0 max-[768px]:mr-2.5 max-[768px]:mt-0 max-[768px]:mb-[5px]"
                          >
                            {skill}
                          </li>
                        ))}
                ...
                <div className="col-[6_/_-1] row-span-full relative z-[1] max-[768px]:col-span-full max-[768px]:h-full max-[768px]:opacity-30">
                  <a href={github || '#'} target={"_blank"} className={`relative z-10 w-full h-full rounded align-middle`}>
                    <img 
                      src={cover} alt={title}
                      className="shadow-custom rounded brightness-[70%] max-[768px]:object-cover max-[768px]:w-full max-[768px]:h-full max-[768px]:grayscale max-[768px]:contrast-100 max-[768px]:brightness-[50%]"
                    />
                  </a>
                </div>
              </li>
