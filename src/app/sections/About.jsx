...
export default function About() {
  ...
  return (
    <section
      ref={aboutRef}
      className={`max-w-5xl mx-auto max-[450px]:pb-14 max-[768px]:pb-20 md:pb-24 transition-all duration-300 ease-in ${rendered ? 'opacity-100 blur-0' : 'opacity-0 blur-md'}
